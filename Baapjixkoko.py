    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            ...
            try:
                ...
                await event.edit("𝐂ʜᴜᴅ ɢʏᴀ sᴀʟᴀ ")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def help(e):
    if e.sender_id in SMEX_USERS:
       text = " 𝗖𝗠𝗗\n\n𝙐𝙩𝙞𝙡𝙨 𝘾𝙤𝙢𝙢𝙖𝙣𝙙:\n.ping\n.restart\n\n𝙐𝙨𝙚𝙧𝙗𝙤𝙩 𝘾𝙤𝙢𝙢𝙖𝙣𝙙:\n.join\n.pjoin\n.leave\n\n𝙎𝙥𝙖𝙢 𝘾𝙤𝙢𝙢𝙖𝙣𝙙:\n.spam\n.delayspam\n.bigspam\n\nFor more help regarding usage of plugins type plugins name\n visit BAAP JII CLAN : @Baapjiiiiiiiiii "
       await e.reply(text, parse_mode=None, link_preview=None )
...
text = """kangers ki maa ka bhosda phle se h 😂😂 😆 kr lo kang tera baap #baapjii"""
print(text)
print("")
print("𝐁𝐚𝐚𝐩𝐣𝐢 🔥 𝐱 𝐤𝐨𝐤𝐨 ❤️ deployed")
